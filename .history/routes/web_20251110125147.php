    ...
    */
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('api')->name('api.')->group(function () {
            Route::get('/users', [AdministrationController::class, 'getUsers'])->name('users.index');
            Route::post('/users', [AdministrationController::class, 'store'])->name('users.store');
            Route::get('/users/{id}', [AdministrationController::class, 'show'])->name('users.show');
            Route::put('/users/{id}', [AdministrationController::class, 'update'])->name('users.update');
            Route::delete('/users/{id}', [AdministrationController::class, 'destroy'])->name('users.destroy');
            Route::post('/users/{id}/block', [AdministrationController::class, 'block'])->name('users.block');
            Route::post('/users/{id}/unblock', [AdministrationController::class, 'unblock'])->name('users.unblock');
            Route::post('/users/{id}/resend-activation', [AdministrationController::class, 'resendActivation'])->name('users.resend-activation');
            Route::post('/generate-matricule', [AdministrationController::class, 'generateMatricule'])->name('generate-matricule');
        });
