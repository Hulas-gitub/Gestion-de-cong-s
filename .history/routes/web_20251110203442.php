...
Route::middleware(['guest'])->group(function () {
    ...
    // ✅ Ajout de la route GET pour /login (affiche la page si on tape directement /login)
    Route::get('/index', [AuthController::class, 'showLoginForm'])->name('login.form');
    ...
    Route::get('/auth/activation-du-compte/{token}', [AccountActivationController::class, 'showActivationForm'])->name('account.activation.form');
    Route::post('/auth/activation-du-compte', [AccountActivationController::class, 'activate'])->name('account.activation.activate');
    Route::post('/auth/activation-du-compte/verify-token', [AccountActivationController::class, 'verifyToken'])->name('account.activation.verify');
});
