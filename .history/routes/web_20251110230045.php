...
Route::middleware(['guest'])->group(function () {
    ...
    // ✅ AJOUT : Route GET pour /login (afficher le formulaire)
...
// Routes pour l'administration (à ajouter dans web.php)

Route::middleware(['auth', 'role:Admin'])->prefix('admin/administration')->name('admin.administration.')->group(function () {
    // Page principale
    Route::get('/', [AdministrationControllers::class, 'index'])->name('index');
