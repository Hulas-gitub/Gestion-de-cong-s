...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        try {
            // Rechercher l'utilisateur par email avec sa relation role et departement
            ...
            if (!$user) {
                Log::warning('❌ Utilisateur non trouvé ou compte inactif', [
                    'email' => $request->email
                ]);
            ...
            Log::info('✅ Utilisateur trouvé', [
                ...
                'password_starts_with' => substr($user->password, 0, 7), // Pour vérifier le format bcrypt
            ]);
