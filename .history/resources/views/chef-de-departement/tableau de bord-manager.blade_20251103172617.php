...
<nav class="space-y-3 flex-1">
    <a href="{{ url('/chef-de-departement/tableau-de-bord') }}" class="nav-item flex items-center space-x-4 px-4 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover-lift transition-all duration-300 click-scale shadow-lg">
