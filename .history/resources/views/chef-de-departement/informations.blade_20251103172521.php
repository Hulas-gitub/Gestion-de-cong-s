...
<head>
  ...
  <script src="{{assets('assets/javascript/config.js')}}"></script>
       <script src="{{assets('assets/javascript/animate.js')}}"></script>
...
<nav class="space-y-3 flex-1">
    <a href="{{ url('/chef-de-departement/tableau-de-bord') }}" class="nav-item flex items-center space-x-4 px-4 py-4 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl hover-lift transition-all duration-300 click-scale">
    ...
    <a href="{{ url('/chef-de-departement/calendrier') }}" class="nav-item flex items-center space-x-4 px-4 py-4 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl hover-lift transition-all duration-300 click-scale">
        <i class="fas fa-umbrella-beach w-5 h-5 text-lg"></i>
        <span>Congés</span>
    </a>
    <a href="{{ url('/chef-de-departement/informations') }}" class="nav-item flex items-center space-x-4 px-4 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover-lift transition-all duration-300 click-scale shadow-lg">
