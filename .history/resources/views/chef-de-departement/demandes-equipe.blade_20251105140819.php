...
<div class="container-fluid px-2 px-md-4 mb-4">
    <div class="bg-white dark:bg-gray-800 rounded-3 shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden animate-slide-up"
        style="animation-delay: 0.6s;">

        <!-- En-tête du tableau -->
        <div class="p-3 p-md-4 border-bottom border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-500/5 to-purple-500/5">
            <h3 class="h5 fw-bold text-gray-900 dark:text-white mb-0">Employés du Département</h3>
        </div>
        ...
        <div class="p-3 p-md-4">
            ...
            <div class="row g-3 mb-4">
                <div class="col-12 col-md-8">
                    <input type="text"
                           ...
                           class="form-control border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                </div>
                <div class="col-12 col-md-4">
                    <select id="positionFilter"
                            class="form-select border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
            ...
            <!-- Tableau des Employés - Version Responsive -->
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light dark:bg-gray-700">
                        <tr>
                            <th scope="col" class="px-3 py-3 text-start text-uppercase fw-semibold text-gray-600 dark:text-gray-300 small">
                                Employé
                            </th>
                            <th scope="col" class="px-3 py-3 text-start text-uppercase fw-semibold text-gray-600 dark:text-gray-300 small d-none d-md-table-cell">
                                Poste
                            </th>
                            <th scope="col" class="px-3 py-3 text-start text-uppercase fw-semibold text-gray-600 dark:text-gray-300 small d-none d-lg-table-cell">
                                Contact
                            </th>
                            <th scope="col" class="px-3 py-3 text-start text-uppercase fw-semibold text-gray-600 dark:text-gray-300 small d-none d-md-table-cell">
                                Status
                    ...
                    <tbody id="employeeTableBody" class="bg-white dark:bg-gray-800">
...
<style>
/* FIX POUR LE MENU HAMBURGER - NE PAS SUPPRIMER */

/* S'assurer que le tableau ne déborde pas et ne cache pas le menu */
.table-responsive {
    max-width: 100%;
    overflow-x: auto;
...
/* Le menu hamburger doit toujours être au-dessus */
.navbar-toggler,
.navbar-toggler-icon {
    position: relative;
...
/* Empêcher le tableau de déborder sur mobile */
@media (max-width: 767.98px) {
    ...
    /* Réduire l'espacement pour éviter le débordement */
    .table td,
    .table th {
