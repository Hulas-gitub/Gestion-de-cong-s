...
<nav class="space-y-3 flex-1">
    ...
    <a href="{{ url('/chef-de-departement/calendrier') }}" class="nav-item flex items-center space-x-4 px-4 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover-lift transition-all duration-300 click-scale shadow-lg">
...
<div id="toast" class="fixed top-4 right-4 bg-white dark:bg-gray-800 border-l-4 border-green-500 rounded-lg shadow-lg p-4 transform translate-x-full transition-transform duration-300 z-50 min-w-80">
    ...
    </div><script src="{{ asset('assets/javascript/config.js') }}"></script>
