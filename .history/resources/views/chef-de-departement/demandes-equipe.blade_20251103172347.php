...
<nav class="space-y-3 flex-1">
    ...
    <a href="{{ url('/chef-de-departement/demande-equipe') }}" class="nav-item flex items-center space-x-4 px-4 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover-lift transition-all duration-300 click-scale shadow-lg">
...
<div class="flex justify-center mb-10">
    <div class="w-32 h-32 rounded-2xl flex items-center justify-center shadow-lg">
        <img src="{{ asset('assets/images/logo.png') }}" alt="Logo Graxel Tech" class="max-w-full max-h-full object-contain rounded-2xl" />
    </div>
</div>
