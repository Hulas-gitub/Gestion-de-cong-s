            ...
            <div class="p-6 h-full flex flex-col">
                ...
                <nav class="space-y-3 flex-1">
                 ...
                 <i class="fas fa-clipboard-list w-5 h-5 text-lg"></i>
                    ...
                    <a href="{{ url('admin/calendrier') }}" class="nav-item flex items-center space-x-4 px-4 py-4 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl hover-lift transition-all duration-300 click-scale">
