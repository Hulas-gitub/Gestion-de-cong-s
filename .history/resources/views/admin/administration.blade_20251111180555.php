...
<!-- Dashboard Content (à fleur) -->
    ...
    <script>
    // Passer les données PHP au JavaScript pour utilisation dans votre fichier JS externe
    window.adminData = {
        roles: @json($roles),
        ...
        routes: {
            ...
            usersUpdate: '/admin/users/',
            usersShow: '/admin/users/',
            usersDelete: '/admin/users/',
            usersBlock: '/admin/users/',
            usersUnblock: '/admin/users/',
            usersResendActivation: '/admin/users/',
            departementsStore: '{{ route("admin.departements.store") }}',
            departementsUpdate: '/admin/departements/',
            departementsShow: '/admin/departements/',
            departementsDelete: '/admin/departements/',
