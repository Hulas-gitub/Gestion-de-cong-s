...
<!-- Script d'injection des données Laravel -->
<script>
    window.laravelData = {
        roles: @json($roles),
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <!-- En-tête -->
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-6 animate-slide-up">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                        Administration
                    </h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1" id="current-date"></p>
                </div>
                <div class="flex items-center space-x-4">
        ...
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-4 animate-slide-up">
            <div class="flex flex-wrap gap-2">
                <button class="tab-button active px-4 py-2 rounded-lg font-medium transition-all duration-300" data-tab="employes">
                    <i class="fas fa-users mr-2"></i>Employés
                </button>
                <button class="tab-button px-4 py-2 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300" data-tab="chefs">
                    <i class="fas fa-user-tie mr-2"></i>Chefs de Département
                </button>
                <button class="tab-button px-4 py-2 rounded-lg font-medium transition-all duration-300 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300" data-tab="departements">
                ...
                <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 animate-slide-up overflow-hidden">
                    <div class="p-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-500/5 to-purple-500/5">
                        <div class="flex items-center justify-between">
                            ...
                            <button id="add-employe-btn" class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-lg transition-colors shadow-lg hover:shadow-xl">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody id="employes-tbody" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                ...
                <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 animate-slide-up overflow-hidden">
                    <div class="p-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-500/5 to-purple-500/5">
                        <div class="flex items-center justify-between">
                            ...
                            <button id="add-chef-btn" class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-lg transition-colors shadow-lg hover:shadow-xl">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody id="chefs-tbody" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                ...
                <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 animate-slide-up overflow-hidden">
                    <div class="p-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-blue-500/5 to-purple-500/5">
                        <div class="flex items-center justify-between">
                            ...
                            <button id="add-departement-btn" class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-lg transition-colors shadow-lg hover:shadow-xl">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody id="departements-tbody" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">Fonctionnalité à implémenter</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<!-- Loader global -->
<div id="loader" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-[9998] hidden flex items-center justify-center">
                ...
                <form id="employe-form">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="tel" id="employe-telephone" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white" placeholder="+241 XX XX XX XX">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="employe-profession" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        </div>
                        ...
                        <div>
                            ...
                            <select id="employe-departement" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Solde de congés annuel <span class="text-red-500">*</span></label>
                            <input type="number" id="employe-solde-conges" min="0" max="60" value="30" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white" required>
                        </div>
                    </div>
                ...
                <form id="chef-form">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="chef-role-display" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white" value="Chef de Département" readonly>
                            <input type="hidden" id="chef-role" value="">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Département <span class="text-red-500">*</span></label>
