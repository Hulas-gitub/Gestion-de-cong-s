        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                <form id="employe-form">
                    <div class="space-y-4">
                        <!-- Matricule (caché lors de l'ajout, visible en lecture seule lors de la modification) -->
                        <div>
                        ...
                        <!-- Rôle (pré-rempli automatiquement) -->
                        <div>
                            ...
                            <select id="employe-role" required
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                                <!-- Rempli dynamiquement avec les rôles "Employé" -->
                            </select>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="chef-role" required
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                                <!-- Rempli dynamiquement avec les rôles "Chef" -->
                            </select>
                        </div>
                        ...
                        <!-- Date de nomination -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Date de nomination <span class="text-red-500">*</span></label>
                            <input type="date" id="chef-date-nomination" required
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        </div>
                    </div>
<div>
    ...
    <input type="date" id="chef-date_embauche" name="date_embauche" required
        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
</div>
                    <div class="flex space-x-3 mt-6">
...
<script>
    // Injecter les données Laravel dans JavaScript
    window.laravelData = {
        roles: @json($roles),
        departements: @json($allDepartements),
        users: @json($users)
