...
<!-- Modal Employé -->
    ...
    window.adminData = {
        ...
        routes: {
            ...
            usersShow: '{{ route("admin.users.show", "") }}/',
            usersDelete: '{{ route("admin.users.destroy", "") }}/',
            ...
            departementsUpdate: '{{ route("admin.departements.update", "") }}/',
            departementsShow: '{{ route("admin.departements.show", "") }}/',
            departementsDelete: '{{ route("admin.departements.destroy", "") }}/',
