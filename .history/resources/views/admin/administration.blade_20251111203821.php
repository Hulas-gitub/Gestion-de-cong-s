...
<div class="flex-1 overflow-auto custom-scrollbar">
    ...
    <div class="p-0 md:p-0 space-y-6 w-full">  <!-- Section principale avec filtres -->
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Gestions des utilisateurs</h1>
            <p class="text-gray-600 dark:text-gray-400">Gérer les employés, chefs de département et départements</p>
                ...
                <div class="tab-content">
                    <!-- Onglet Employés  n'affiche que les employé avec le role (employé) pas de melange de donné il ne dis pas affiché les chef de departemnt les données doivent etre filtré-->
     ...
     <button
                ...
                <!-- Onglet Chefs de Département ici on n'affiche que les chef de departement on doit filtré les doonnées-->
     ...
     <button
                ...
                <!-- Onglet Départements ici on affcihe que les departement avec le chef du departement afficher et le nombre d'employé de ce departement-->
     ...
     <button
                ...
                <!-- Modal Employé le champs role doit etre préremplis pour choisir cliquer sur le role "employé" -->
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="employe-role"
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                    required>
                                    <option value="Employé" selected>Employé (donnée préremplis depuis la bdd)</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Département (champs préremplis pour choirir le departemnt depuis la bdd)</label>
                ...
                <form id="employe-form">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="employe-nom" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email</label>
                            <input type="email" id="employe-email" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Téléphone</label>
                            <input type="text" id="employe-telephone" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Département</label>
                            <input type="text" id="employe-departement" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                    </div>
                    <div class="flex justify-end mt-6">
                        <button type="button" onclick="closeModal('employe-modal')" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                            Fermer
                        </button>
                    </div>
                </form>
...
<div id="chef-departement" class="fixed inset-0 z-50 hidden">
    ...
    <div class="modal relative z-10 flex items-center justify-center min-h-screen p-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    Détails du chef de département
                </h3>
            </div>
            <div class="p-6">
                <form id="chef-form">
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nom complet</label>
                            <input type="text" id="chef-nom" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email</label>
                            <input type="email" id="chef-email" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Téléphone</label>
                            <input type="text" id="chef-telephone" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Département dirigé</label>
                            <input type="text" id="chef-departement" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                    </div>
                    <div class="flex justify-end mt-6">
                        <button type="button" onclick="closeModal('chef-modal')" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                            Fermer
                        </button>
                    </div>
                </form>
...
<div id="departement-detail" class="fixed inset-0 z-50 hidden">
                ...
                <form id="departement-form">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="departement-nom" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Description</label>
                            <textarea id="departement-description" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Chef de département</label>
                            <input type="text" id="departement-chef" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" readonly>
                        </div>
                    </div>
                    <div class="flex justify-end mt-6">
                        <button type="button" onclick="closeModal('departement-modal')" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                            Fermer
                        </button>
                    </div>
                </form>
    ...
    <!-- Modal Chef de Département le role -->
                ...
                <div class="p-6">
                    <form id="chef-form">
                        <div class="space-y-4">
                            ...
                            <div>
                                <label
                                 ...
                                 <select id="employe-role"
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                    required>
                                    <option value="Employé" selected>Chef de département(donnée préremplis depuis la bdd)</option>
                                </select>
                            </div>
                            </div>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Département (ce champs récupère les departements depuis la bdd)</label>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Chef de
                                    département cette parti recupère tous les cef de departement en affichant leurs noms</label>
