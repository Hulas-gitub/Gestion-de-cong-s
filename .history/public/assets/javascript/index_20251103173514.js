        ...
        const users = [
            ...
            {
                email: "hulassandersss@gmail.com",
                password: "Hulas1998",
                role: "employee",
                name: "Marie Martin"
            },
    ...
    function redirectByRole(role, userName) {
        ...
        switch(role) {
            case 'admin':
                redirectUrl = '{{ url("/admin/dashboard-admin") }}';
                break;
            case 'manager':
                redirectUrl = '{{ url("/chef-de-departement/tableaude bord-manager") }}';
                break;
            case 'employee':
                redirectUrl = '{{ url("/employes/tableau de bord-employers") }}';
                break;
            default:
                redirectUrl = '{{ url("/employes/tableau de bord-employers") }}';
        }
