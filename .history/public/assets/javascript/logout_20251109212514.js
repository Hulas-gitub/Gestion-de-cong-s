// ==================== FONCTION DE DÉCONNEXION AVEC LARAVEL ====================
...
async function executeLogout() {
    try {
        ...
        // Afficher un message d'erreur avec la fonction showMiniToast si disponible
...
// Alternative: Déconnexion avec fetch (si vous préférez AJAX)
async function executeLogoutAjax() {
    try {
        // Fermer le modal
        closeLogoutModal();
        ...
        if (response.ok) {
            ...
            showLogoutToast('Déconnexion réussie');
